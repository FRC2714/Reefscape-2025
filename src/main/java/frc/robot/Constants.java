...
public final class Constants {
  ...
  public static final class LimelightConstants{
    ...
    public static final double kRightCameraHeight = 10.5 + 2.75;
    public static final double kLeftCameraHeight = 11 + 2.75;
    public static final double kRightMountingAngle = -10;
    public static final double kLeftMountingAngle = -10;
