...
public class AlignToReefCenter extends Command {
  ...
  public AlignToReefCenter(DriveSubsystem m_drivetrain, Limelight m_rightLimelight, Limelight m_leftLimelight) {
  ...
  public void initialize() {
    m_rightLimelight.setCoralTagPipelineCenter();
    m_leftLimelight.setCoralTagPipelineCenter();
  }
